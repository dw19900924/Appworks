// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ServiceLocator.cs" company="Zhulei">
...
namespace Appworks
{
    ...
    /// The service locator.
    /// </summary>
    public sealed class ServiceLocator : DisposableObject, IServiceLocator
    {
        #region Fields
        ...
        {
            this.container = AppRuntime.Instance.CurrentApp.Container;
        }
